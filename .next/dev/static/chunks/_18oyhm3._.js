...
function AdminPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            const handlePaste = {
                "AdminPage.useEffect.handlePaste": async (e)=>{
                    ...
                    if (pastedFiles.length > 0) {
                        ...
                        try {
                            const fileMeta = pastedFiles.map({
                                "AdminPage.useEffect.handlePaste.fileMeta": (f)=>({
                                        fileName: f.name || `pasted-saree-${Date.now()}.png`,
                                        fileType: f.type
                                    })
                            }["AdminPage.useEffect.handlePaste.fileMeta"]);
                            ...
                            const finalUrls = cdnResults.length > 0 ? cdnResults : pastedFiles.map({
                                "AdminPage.useEffect.handlePaste": (f)=>URL.createObjectURL(f)
                            }["AdminPage.useEffect.handlePaste"]);
                            setUploadedCdnUrls({
                                "AdminPage.useEffect.handlePaste": (prev)=>[
                                        ...prev,
                                        ...finalUrls
                                    ]
                            }["AdminPage.useEffect.handlePaste"]);
            ...
            return ({
                "AdminPage.useEffect": ()=>window.removeEventListener('paste', handlePaste)
            })["AdminPage.useEffect"];
        }
    }["AdminPage.useEffect"], []);
...
_s(AdminPage, "eh9I71bsHWcvhXvu2XZO19IwubE=");
_c = AdminPage;
var _c;
